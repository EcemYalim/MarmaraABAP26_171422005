CLASS zcl_171422005_rest_client_02 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_171422005_rest_client_02 IMPLEMENTATION.
...
*    io_out->write( user_delete( ) ).
  ...
  METHOD user_get.
    ...
    rv_text = execute_request(
      iv_method = 'GET'
      iv_url    = gc_base_url && '/user/demo_171422005' ).
  ...
  METHOD build_user_json.
    ...
    rv_json =
      '{' &&
      '"id": 1007,' &&
      '"username": "demo_171422005",' &&
      '"firstName": "ozan",' &&
      '"lastName": "deste",' &&
      '"email": "deste.ozan@example.com",' &&
      '"password": "1234.",' &&
      '"phone": "5550001111",' &&
      '"userStatus": 5' &&
      '}'.
